...
// app/styles/cart.css
var cart_default = "/build/_assets/cart-NTOJ6PCB.css";
...
function Topbar() {
  ...
  (0, import_react.useEffect)(() => {
    const menuButton2 = document.querySelector(".menuIcon");
    ["click", "touch"].forEach(function(e) {
      menuButton2.addEventListener(e, () => clickedMenu());
    });
    return () => {
      menuButton2.removeEventListener("touchstart", () => {
        clickedMenu();
      });
    };
  }, []);
...
//# sourceMappingURL=/build/root-SMF4KNKK.js.map
