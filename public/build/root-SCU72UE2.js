...
// app/styles/cart.css
var cart_default = "/build/_assets/cart-UCJQD6ZV.css";
...
function Sidebar({ items }) {
  ...
  return /* @__PURE__ */ React.createElement("div", {
  ...
  }, firstCategories && firstCategories.map((firstCat, key2) => {
    return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "sidebar__categories"
  }, secondCategories && secondCategories.map((secondCat, key2) => {
    return /* @__PURE__ */ React.createElement("div", {
      className: "sidebar__category",
      key: key2,
    ...
    className: "sidebar__categories"
  }, thirdCategories && thirdCategories.map((thirdCat, key2) => {
    return /* @__PURE__ */ React.createElement("div", {
      className: "sidebar__category",
      key: key2
...
var Cart = () => {
  ...
  }, "My Cart"), /* @__PURE__ */ React.createElement("pre", null, JSON.stringify(items, null, 4)));
};
...
//# sourceMappingURL=/build/root-SCU72UE2.js.map
