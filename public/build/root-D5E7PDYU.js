...
function Sidebar({ items }) {
  ...
  function clickedSecondOpt(category) {
    const thirdPage = document.querySelector(".sidebar__thirdPage");
    const localThird = items && items.filter((it) => it.page === 2 && it.parentID === category.id);
  ...
  }, "Nothing here!"), secondCategories && secondCategories.map((secondCat, key) => {
    return /* @__PURE__ */ React.createElement("div", {
      className: "sidebar__category",
      key,
...
//# sourceMappingURL=/build/root-D5E7PDYU.js.map
